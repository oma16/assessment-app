    ...
    <div className="lg:p-24">
          ...
          <div className="flex flex-col lg:flex-row px-2 md:px-8 lg:px-2 xl:px-[86px] justify-between w-full mt-12 md:mt-24">
            <div className=" lg:w-1/2 xl:w-3/4 mb-10 ">
              ...
              <p className=" text-sm text-[#292929] leading-4 font-normal">
                Another way to improve the readability of a website or app is to
                use clear and concise navigation. This helps to make it easy for
                you to find the information or features that you are looking
                for. It also helps to prevent you from becoming lost or
                overwhelmed.
              </p>
            </div>
            <div className="flex flex-col md:flex-row self-center justify-center w-full  lg:w-2/5">
              <div>
                <button
                  id="btn"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-6 px-6 lg:px-0">
        <div className="border-[#EFEFEF] p-6 border rounded-lg overflow-auto">
          <div>
            <h1 className="text-[#292929] text-base font-medium ">
              Real-Time Sales
            </h1>
                ...
                {productData.map((product, index) => (
                  <div key={index}>
                    <img
                      ...
                      className="mb-3 "
                    />
                    <p className="text-[#989898] font-medium text-xs ">
            ...
            <table className=" table border-collapse border-spacing-32 w-full border border-[#EFEFEF] rounded-tl-lg rounded-tr-lg">
              <thead className="bg-[#3D006C] text-white rounded-tl-lg rounded-tr-lg ">
                <tr className="text-justify  ">
                  <th className="px-1  md:px-0 md:pl-5 py-3 rounded-tl-lg ">Product Name</th>
                  <th className="px-1  md:px-0 md:pl-5">Order number</th>
                  <th className="px-1 md:px-0 md:pl-5">Date</th>
                  <th className="px-1 md:px-0 md:pl-5">Price</th>
                  <th className="px-1 md:px-0 md:pl-5 rounded-tr-lg">Status</th>
                </tr>
              </thead>
              <tbody className="text-[#989898] text-sm font-normal">
                <tr className="border border-b">
                  <td className="flex py-5">
                    <div className="w-5 h-4 md:w-10 md:h-10 bg-[#A946FF] rounded-full mx-5"></div>
                    <div>
                      <p>Product Name</p>
                  ...
                  <td>12 - April - 2023</td>
                  <td>N10,000</td>
                  <td className="flex justify-center  mb-8 mr-5  bg-[#CFFE98] rounded-[99px] px-3 py-1 text-sm text-[#153003] font-medium text-center">
                    <p className="self-center">Completed</p>
                  </td>
                </tr>
                <tr className="py-5">
                  <td className="flex py-5">
                  ...
                  <td>12 - April - 2023</td>
                  <td>N10,000</td>
                  <td className=" flex justify-center mb-8 mr-5 self-center bg-[#F1FFC8] rounded-[99px] px-4 py-1 text-sm text-[#1D3102] font-medium text-center">
                    Pending
                  </td>
                </tr>
              </tbody>
